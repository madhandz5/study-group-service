...
import com.studywara.settings.form.Notifications;
import com.studywara.settings.form.PasswordForm;
import com.studywara.settings.form.Profile;
...
public class SettingsController {
    ...
    public String updateProfile(@CurrentUser Account account, @Valid Profile profile, Errors errors, Model model, RedirectAttributes redirectAttributes){
        if(errors.hasErrors()){
            model.addAttribute(account);
            return SETTINGS_PROFILE_VIEW_NAME;
        }
    ...
    public String updatePassword(@CurrentUser Account account, @Valid PasswordForm passwordForm, Errors errors, Model model, RedirectAttributes attributes){
        ...
        attributes.addFlashAttribute("message", "패스워드를 변경햇습니다.");
